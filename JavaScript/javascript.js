...
// every
// will return the boolean value , used to test soemthing in every elemen tin an array
...
// to access the object properties we normally use the. keyword
...
const objj = Object.create(objecta)
console.log(objj , "Object.create()")

// object single terons
const obj1 = {
    1: "a",
    2: 'b'
...
//obj assign will help to merge the two object into one
// it takes two parameters which is target and source, normally the target is {}
