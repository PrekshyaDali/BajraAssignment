...
nodediv.prepend("button")//at the front of the div
nodediv.append("button")//at the alst of the div
nodediv.before("button") //just before the node addition
nodediv.after("button")//just after the node
